...
Route::post('edit/{id}', 'UserController@updateUser')->middleware('isLoggedIn');
Route::get('edit/{id}', 'UserController@editUser')->middleware('isLoggedIn');
Route::get('delete/{id}', 'UserController@deleteUser')->middleware('isLoggedIn');
