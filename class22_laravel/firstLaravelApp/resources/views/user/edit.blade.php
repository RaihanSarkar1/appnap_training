        ...
        <div class="panel-body">
            ...
            <form action="{{ url('add_user') }}" role="form" id="form1" method="post" class="validate">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$user->name}}" name="name" id="name" data-validate="required" data-message-required="This is custom message for required field." placeholder="Required Field" />
                </div>

                <div class="form-group">
                    <label class="control-label">Email</label>

                    <input type="email" class="form-control" value="{{$user->email}}" name="email" id="email" data-validate="required" data-message-required="This is custom message for required field." placeholder="Required Field" />
